...
// source: https://github.com/GoogleCloudPlatform/golang-samples/blob/main/pubsublite/quickstart_publisher/main.go
func Publish(projectID string, zone string, topicID string, messageCount int) {
